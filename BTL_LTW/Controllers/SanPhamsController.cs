...
namespace BTL_LTW.Controllers
{
    public class SanPhamsController : Controller
    {
        ...
        public SanPhamsController(MaleFashionContext context)
        {
            _context = context;
        }
        ...
        {
            var maleFashionContext = _context.SanPhams.Include(s => s.MaDanhMucNavigation);
            return View(await maleFashionContext.ToListAsync());
        }
